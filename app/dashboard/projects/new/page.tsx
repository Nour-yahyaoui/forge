  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-500 mb-6">Create a project and invite members with a join code</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-400 mt-1">Add this later if you don't have it yet</p>
          </div>
