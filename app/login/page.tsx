        ...
        <section className="py-12 md:py-16 max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              <button type="button" onClick={() => handleSocialLogin("Google")} className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 py-3 font-semibold hover:bg-gray-50 transition">
                <FaGoogle className="text-red-500 text-lg" /> Continue with Google
              </button>
              <button type="button" onClick={() => handleSocialLogin("GitHub")} className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 py-3 font-semibold hover:bg-gray-50 transition">
            ...
            <div>
              ...
              <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full px-4 py-3 border-2 border-gray-200 focus:border-red-600 outline-none transition bg-gray-50" placeholder="••••••••" minLength={8} />
            </div>
          ...
          <p className="text-center text-gray-600 mt-6 text-sm">
            Don't have an account? <Link href="/register" className="text-red-600 font-semibold hover:underline">Register</Link>
          </p>
        </section>
